...
if (Cookies.get('menu')) {
    ...
    // menu.classList.contains('hidden') ? container.classList.add('col-12') : container.classList.remove('col-10');
} else {

}
var toogleEvent = function () {
    menu.classList.contains('hidden') ? menu.classList.remove('hidden') : menu.classList.add('hidden');
    // menu.classList.contains('hidden') ? container.classList.add('col-10') : container.classList.remove('col-12');
